...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      console.log('Looking up subdomain:', normalizedSubdomain);

      // Get attorney data from config
      const attorneyData = configData[normalizedSubdomain] || {
        firmName: 'LegalScout',
      ...
      if (
        ...
        attorneyData.firmName = "General Counsel Online";
        attorneyData.logo = "https://storage.googleapis.com/glide-prod.appspot.com/uploads-v2/pSrOHjaijGufsy7FzIva/pub/1ivEGn6E6pjoAmFHAwSU.png";
        attorneyData.vapiInstructions = "I provide Business Law for clients in Pennsylvania. I want to know their company domicile, business structure, and legal or business issue they're facing. I need to make sure this is a business and not an individual matter this is concerning. Refer the user to https://generalcounsel.online if they need more information about General Counsel Online.";
      }
