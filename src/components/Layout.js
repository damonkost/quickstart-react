      ...
      <header>
        <nav>
          <div className="logo-container">
            <img 
              className="logo" 
              src={profile?.logo || "https://res.cloudinary.com/glide/image/fetch/f_auto,c_limit/https%3A%2F%2Ffirebasestorage.googleapis.com%2Fv0%2Fb%2Fglide-prod.appspot.com%2Fo%2Ficon-images%252Fanonymous-4ec86c98-f143-4160-851d-892f167b223c.png%3Falt%3Dmedia%26token%3Dcdc26513-26ae-48f6-b085-85b8bb806c4c"} 
              alt={`${profile?.firmName || 'LegalScout'} Logo`}
            />
          </div>
